...
class ExecutorTest(tf.test.TestCase):
  ...
  @mock.patch.multiple(
      utils,
      read_from_big_query_impl=_MockReadFromBigQuery2,  # pylint: disable=invalid-name, unused-argument
  )
  ...
  def testBigQueryToElwc(self, mock_client):
    ...
    with beam.Pipeline() as pipeline:
              ...
              exec_properties={
                  ...
                  'elwc_config':
                      json_format.MessageToJson(
                          elwc_config_pb2.ElwcConfig(context_feature_fields=[
                              'context_feature_1', 'context_feature_2'
                          ]),
      ...
      expected_elwc_examples = [ELWC_1, ELWC_2, ELWC_3, ELWC_4, ELWC_5]
