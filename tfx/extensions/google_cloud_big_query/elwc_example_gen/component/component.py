...
from tfx.extensions.google_cloud_big_query.elwc_example_gen.component import executor
...
class BigQueryToElwcExampleGenSpec(ComponentSpec):
  """BigQueryToElwcExampleGen component spec."""

  PARAMETERS = {
      'input_config': ExecutionParameter(type=example_gen_pb2.Input),
      'output_config': ExecutionParameter(type=example_gen_pb2.Output),
      'elwc_config': ExecutionParameter(type=elwc_config_pb2.ElwcConfig)
  }
  INPUTS = {}
  OUTPUTS = {
...
class BigQueryToElwcExampleGen(base_component.BaseComponent):
  ...
  SPEC_CLASS = BigQueryToElwcExampleGenSpec
  ...
  def __init__(self,
    ...
    Args:
      ...
      elwc_config: The elwc config contains a list of context feature fields.
        ...
        instance. For example, when there are two examples with the same
        context field, the two examples will be intergrated to a ELWC instance.
    ...
    spec = BigQueryToElwcExampleGenSpec(
        input_config=input_config,
        output_config=output_config,
        elwc_config=elwc_config,
