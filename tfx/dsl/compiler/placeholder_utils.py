...
class _ExpressionResolver:
  ...
  def __init__(self, context: ResolutionContext):
    self._context_kinds = {
        ...
        placeholder_pb2.Placeholder.Type.CONTEXT: {
            "executor_spec": context.executor_spec,
            "platform_config": context.platform_config,
            "stateful_working_dir": context.exec_info.stateful_working_dir,
            "executor_output_uri": context.exec_info.executor_output_uri,
            "node_info": context.exec_info.pipeline_node.node_info,
            "pipeline_info": context.exec_info.pipeline_info,
        }
    }
  ...
  def _resolve_placeholder(self,
    ...
    try:
      context = self._context_kinds[placeholder.type]
